/* @generated */var AnsiColorDescriptionError, BASIC_COLORS, SYSTEM_CODES, ansi, ansi256ColorCodeForDescription, c, capitalizedCssColors, colorDistance, hex, hexToAnsi, i, isArray, isNumber, isObject, isString, name, nameForAnsi256ColorCode, namesToAnsiColors, rgbFloatToAnsi, rgbToAnsi, xterm256Colors, _i, _j, _len, _ref,
...
_ref = ['black', 'red', 'green', 'yellow', 'blue', 'magenta', 'cyan', 'white', 'gray'];
...
ansi256ColorCodeForDescription = function(desc) {
  ...
  var b, g, lc, r, _ref1, _ref2, _ref3;
  if (isString(desc)) {
    if (BASIC_COLORS[desc] != null) {
  ...
  if (isObject(desc)) {
    r = (function() {
      var _ref2;
      if ((_ref1 = (_ref2 = desc.r) != null ? _ref2 : desc.red) != null) {
        return _ref1;
      } else {
    ...
    g = (function() {
      var _ref3;
      if ((_ref2 = (_ref3 = desc.g) != null ? _ref3 : desc.green) != null) {
        return _ref2;
      } else {
    ...
    b = (function() {
      var _ref4;
      if ((_ref3 = (_ref4 = desc.b) != null ? _ref4 : desc.blue) != null) {
        return _ref3;
      } else {
